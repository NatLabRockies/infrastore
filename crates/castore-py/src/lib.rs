//! PyO3 bindings for `castore`.
//!
//! Exposed module name: `castore`. Top-level surface:
//!
//! ```python
//! from castore import (
...
create_exception!(castore, TimeSeriesError, PyException);
create_exception!(castore, NotFoundError, TimeSeriesError);
create_exception!(castore, DuplicateTimeSeriesError, TimeSeriesError);
create_exception!(castore, DuplicateAssociationError, TimeSeriesError);
create_exception!(castore, InvalidParameterError, TimeSeriesError);
create_exception!(castore, IntegrityError, TimeSeriesError);
create_exception!(castore, ReadOnlyStoreError, TimeSeriesError);
create_exception!(castore, IoError, TimeSeriesError);
create_exception!(castore, ConnectionError, TimeSeriesError);
create_exception!(castore, IncompatibleFormatError, TimeSeriesError);
create_exception!(castore, IncompatibleForecastError, TimeSeriesError);
create_exception!(castore, StorageError, TimeSeriesError);
...
#[pyclass(eq, eq_int, name = "OwnerCategory", module = "castore", from_py_object)]
#[derive(Clone, Copy, PartialEq, Eq)]
...
#[pyclass(name = "Deterministic", module = "castore", from_py_object)]
#[derive(Clone)]
...
#[pyclass(name = "Probabilistic", module = "castore", from_py_object)]
#[derive(Clone)]
...
#[pyclass(name = "Scenarios", module = "castore", from_py_object)]
#[derive(Clone)]
...
#[pyclass(name = "SingleTimeSeries", module = "castore", from_py_object)]
#[derive(Clone)]
...
#[pyclass(name = "NonSequentialTimeSeries", module = "castore", from_py_object)]
#[derive(Clone)]
...
#[pyclass(name = "TimeSeriesKey", module = "castore", from_py_object)]
#[derive(Clone)]
...
#[pyclass(name = "ParentChildAssociation", module = "castore", from_py_object)]
#[derive(Clone)]
...
/// `group_values`.
#[pyclass(name = "StaticReader", module = "castore", unsendable)]
...
/// `entry_values`.
#[pyclass(name = "ForecastReader", module = "castore", unsendable)]
...
#[pyclass(name = "Store", module = "castore", unsendable)]
pub struct PyStore {
...
/// `"debug"`, `"castore_core=debug"`, or `"warn,castore_core=trace"`.
///
...
#[pymodule]
fn castore(py: Python<'_>, m: &Bound<'_, PyModule>) -> PyResult<()> {
