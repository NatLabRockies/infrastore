...
fn decode_full_key(k: time_series_store_proto::pb::TimeSeriesKey) -> CoreResult<TimeSeriesKey> {
...
use time_series_store_proto::pb::{
    ...
    ResolveForecastKeyReq, VerifyReq, time_series_store_client::TimeSeriesStoreClient,
};
...
impl RemoteClient {
    ...
    pub async fn resolve_forecast_key(
        ...
        resolution: Option<Period>,
        interval: Option<Period>,
        features: time_series_store_core::Features,
