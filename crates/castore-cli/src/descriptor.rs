...
impl Descriptor {
    ...
    fn regular_params(
        &self,
    ) -> Result<(chrono::DateTime<chrono::Utc>, castore_core::Period), String> {
        let initial = self
            .initial_timestamp
            .as_ref()
    ...
    fn period_field(&self, field: &str) -> Result<castore_core::Period, String> {
        let raw = match field {
