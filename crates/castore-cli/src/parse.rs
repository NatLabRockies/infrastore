...
use castore_core::{Dtype, FeatureValue, OwnerCategory, Period, TimeSeriesType};
...
pub fn parse_compression(spec: &str, shuffle: bool) -> Result<castore_core::Compression, String> {
    use castore_core::Compression;
