...
class CatalogMigrationRequiredError(TimeSeriesError): ...
class CatalogTooNewError(TimeSeriesError): ...
...
@final
class Transaction:
    """Context manager returned by `Store.transaction()`.

    Commits on a clean exit and rolls back if the block raises. Never suppresses
...
class Store:
    ...
    @write_buffer_bytes.setter
    def write_buffer_bytes(self, bytes: int) -> None: ...
    def close(self) -> None: ...
