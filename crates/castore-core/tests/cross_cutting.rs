...
fn store_is_send_but_not_sync() {
    ...
    assert_send_sync::<castore_core::StaticReader>();
    assert_send_sync::<castore_core::ForecastReader>();
    assert_send_sync::<castore_core::TimeSeriesKey>();
    assert_send_sync::<castore_core::TimeSeriesData>();
    assert_send_sync::<castore_core::TypedArray>();
}
...
fn a_reader_built_before_a_removal_of_an_unshared_array_errors() {
    ...
    assert!(
        matches!(err, castore_core::TimeSeriesError::NotFound),
