...
reaches the width one chunk row holds (131,072 scalar `Float64` columns) or the unwritten arrays
cross 128 MiB (an extra dataset, nothing else — the same split a batch that wide gets), and a span
