...
This page covers the conventions for contributing code and documentation to castore.
...
# Python
cd crates/castore-py && maturin develop && pytest ../../python/tests

# Julia (requires the cdylib + CASTORE_LIB)
...
- The C header `crates/castore-ffi/include/castore.h` is generated by cbindgen — do not hand-edit
  it; it is refreshed when you build `castore-ffi`.
- The proto-derived Rust types in `castore-proto` are generated by `tonic` from
